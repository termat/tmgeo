...
public class TableSorter extends AbstractTableModel {
    ...
    private NumComparator numC=new NumComparator();
    ...
    protected Comparator getComparator(int column) {
        ...
        if(columnType==Number.class)return numC;
    ...
    public Object getValueAt(int row, int column) {
    	Object o=tableModel.getValueAt(modelIndex(row), column);
        return o;
    }
...
//				loadSelectedRow(h.getTable(), list, keyCol);
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    private class NumComparator implements Comparator{
		...
		public int compare(Object arg0, Object arg1) {
			if((arg0 instanceof Number)&&(arg1 instanceof Number)){
				double v0=((Number)arg0).doubleValue();
				double v1=((Number)arg1).doubleValue();
				if(v0>v1){
					return 1;
				}else if(v0==v1){
					return 0;
